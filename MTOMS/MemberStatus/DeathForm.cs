...
namespace MTOMS
{
    public partial class DeathForm : DevComponents.DotNetBar.Office2007Form
    {
        public DeathForm()
        {
            InitializeComponent();
        ...
        string[] _canc = new string[] { "death_date","cause","comment" };
        ...
        private void LoadMainGrid()
        {
            try
            {
                ...
                _row.Height = 5;
                _row.BackColor = Color.Lavender;
                _row = CreateNewRow("* Passed Away On", "death_date", typeof(Int32), group_index, group_name);
                ...
                _row.Cells["name"].ForeColor = Color.Red;
               
                
                _row = CreateNewRow("Cause", "cause", typeof(string), group_index, group_name);
                _row.Height = 60;
